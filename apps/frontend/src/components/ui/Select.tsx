...
CustomSelectTrigger.displayName = RadixSelectTrigger.displayName;
...
CustomSelectContent.displayName = RadixSelectContent.displayName;
...
CustomSelectItem.displayName = RadixSelectItem.displayName;

// Export using original names
export {
  Select,
